...
public class DataExportUtility {
    ...
    public static final String getExportOfStackTraces(List<StackTrace> traces, boolean withFrames, Timestamp ts) {
        String output = "";
        ...
        for (StackTrace trace : traces) {
            ...
            output += trace.getException() + "\n";

            // As well as the Reason
            output += trace.getReason() + "\n";
    ...
    public static final String getExportOfPatches(List<Patch> patches, boolean withHunks) {
        String output = "";
        ...
        for (Patch patch : patches) {
            ...
            // Add the index
            output += patch.getIndex() + "\n";

            // Add the original File
            output += patch.getOriginalFile() + "\n";

            // Add the modified File
            output += patch.getModifiedFile() + "\n";
    ...
    public static final String getExportOfSourceCode(List<CodeRegion> coderegions, boolean withCode) {
        String output = "";
    ...
    public static final String getExportOfEnumerations(List<Enumeration> enumerations, boolean withLines) {
        String output = "";
